...
def segundo(node_inicio):
    L_Dist_final=[100,100,100,100,100,100,100,100]
    def algor(node_inicio,L_Dist_final):
        for x,i in enumerate(a):
            valtramo=Matriz[i][node_final]
            Matriz[i][node_final]=100
            contador=0
            cont2=0
            contador3=0
            cont3=0
            ...
            return L_Dist_final,camino_final
    distfinal2,caminofinal2=algor(node_inicio,L_Dist_final)
    print(Fore.RED,'El segundo camino es',caminofinal2)
    print('El resultado del segundo camino es',distfinal2[node_final],Fore.WHITE)
segundo(node_inicio)